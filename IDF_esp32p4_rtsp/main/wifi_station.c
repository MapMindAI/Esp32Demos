...
*/
#define EXAMPLE_ESP_WIFI_SSID "DEEP-RD"
#define EXAMPLE_ESP_WIFI_PASS "07310731"
      ...
      .sta =
          {
               ...
               * networks, Please set the threshold value to WIFI_AUTH_WEP/WIFI_AUTH_WPA_PSK and set
               * the password with length and format matching to WIFI_AUTH_WEP/WIFI_AUTH_WPA_PSK
               * standards.
               */
