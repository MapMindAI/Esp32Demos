...
typedef enum { MCP_20MHZ, MCP_16MHZ, MCP_8MHZ } CAN_CLOCK_t;
...
typedef enum { MASK0, MASK1 } MASK_t;

typedef enum { RXF0 = 0, RXF1 = 1, RXF2 = 2, RXF3 = 3, RXF4 = 4, RXF5 = 5 } RXF_t;

typedef enum { RXB0 = 0, RXB1 = 1 } RXBn_t;

typedef enum { TXB0 = 0, TXB1 = 1, TXB2 = 2 } TXBn_t;
...
typedef enum { STAT_RX0IF = (uint8_t)(1 << 0), STAT_RX1IF = (uint8_t)(1 << 1) } STAT_t;
